 ...
 * #syncSelected/#setActive) and opens/closes/positions the popup — same
 * flip-when-tight-on-room placement logic as `ui-combobox`.
 */
...
export class Select extends LitElement {
  ...
  // but there is more room above than below — same algorithm as ui-combobox's
  // #updatePlacement.
  #updatePlacement() {
    ...
    this.placement =
      listbox.offsetHeight > spaceBelow && spaceAbove > spaceBelow
        ? "top"
        : "bottom";
  }
