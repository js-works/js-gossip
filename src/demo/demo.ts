...
import type { DialogType, FormDialogResult, ToastType } from "../main/index.js";
...
import "./ui/components/checkbox/checkbox-group.js";
import type { CheckboxGroup } from "./ui/components/checkbox/checkbox-group.js";
import "./ui/components/radio/radio-button.js";
import "./ui/components/radio/radio-group.js";
import type { RadioGroup } from "./ui/components/radio/radio-group.js";
import "./ui/components/button/button.js";
import "./ui/components/select/select.js";
import type { Select } from "./ui/components/select/select.js";
import type { Button } from "./ui/components/button/button.js";
import { localFilter } from "./ui/components/combobox/combobox.js";
import type {
  Combobox,
  ComboboxItemGroup,
} from "./ui/components/combobox/combobox.js";
...
// Sample data for the ui-combobox demo below — grouped to show the labeled
// separators ComboboxItemGroup produces in the dropdown.
const FRUITS: ComboboxItemGroup[] = [
...
const page = html`
  <ui-combobox
    ...
    @change=${(e: Event) =>
      log("Combobox picked", (e.target as Combobox).value)}
  ></ui-combobox>
  <main class="page">
    <div>
      ...
      <section>
        ...
        <div class="row">
          <ui-select
            ...
            @change=${(e: Event) =>
              log("Select changed", (e.target as Select).value)}
          >
      ...
      <section>
        ...
        <div class="row">
          <ui-radio-group
            ...
            value="standard"
            @change=${(e: Event) =>
              log("Radio group changed", (e.target as RadioGroup).value)}
          >
      ...
      <section>
        ...
        <div class="row">
          <ui-checkbox-group
            ...
            required
            @change=${(e: Event) =>
              log("Checkbox group changed", (e.target as CheckboxGroup).values)}
          >
  ...
  <section class="data-navigator-section hidden-demo">
